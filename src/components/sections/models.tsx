...
const COLORS = {
  ...
  shadowHover: "0 18px 40px rgba(15, 23, 42, 0.07)",
};
...
const modelCards: ModelCard[] = [
  {
    ...
    href: "/models/consult",
    image: consultImage,
    summary: "Business clarity, structure, and strategy for better decisions.",
  },
  {
    title: "Octalve Lab",
    href: "/models/lab",
    image: labImage,
    summary: "Brand, website, and product execution that moves ideas forward.",
  },
  {
    title: "Octalve Leap",
    href: "/models/leap",
    image: leapImage,
    summary: "Startup setup, registration, and launch guidance for founders.",
  },
  {
    title: "Octalve Suite",
    href: "/models/suite",
    image: suiteImage,
    summary: "Launch support, rollout assets, and business visibility support.",
  },
  {
    title: "Octalve Cloud",
    href: "/models/cloud",
  ...
  },
  {
    ...
    href: "/models/vault",
    image: vaultImage,
    summary: "Templates, tools, and resources to support execution.",
  },
  {
    title: "Octalve One",
    href: "/models/one",
    image: oneImage,
    summary: "Software, automation, and AI tools for smarter operations.",
  },
  {
    title: "Octalve Node",
    href: "/models/node",
    image: nodeImage,
    summary:
      "Workspace, virtual office, and startup support for focused growth.",
  },
];
...
export default function Models() {
  ...
  return (
    <section
      id="models"
      className="px-4 py-16 sm:px-6 md:py-20 lg:px-6 lg:py-24"
      style={{ backgroundColor: COLORS.sectionBg }}
    >
      <div className="mx-auto max-w-[1280px]">
        <div className="mx-auto max-w-[980px] text-center">
          <h2
            className="text-4xl font-medium leading-[1.06] tracking-[-0.04em] sm:text-5xl lg:text-[62px]"
            style={{ color: COLORS.heading }}
          >
            Browse all Octalve Models & Services
          </h2>

          <p
            className="mt-5 text-[11px] font-semibold uppercase tracking-[0.26em] sm:text-xs"
            style={{ color: COLORS.eyebrow }}
          >
            Making it easier to access Octalve services, solutions, and growth
            support
          </p>
        </div>

        <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-6">
          {modelCards.map((item, index) => {
            ...
            return (
              ...
              >
                <article
                  className="flex h-full flex-col items-center px-5 pb-7 pt-6 text-center sm:px-6 sm:pb-8 sm:pt-7"
                  style={{
                    minHeight: UI.cardMinHeight,
                    borderRadius: UI.cardRadius,
                    backgroundColor: COLORS.cardBg,
                    border: `1px solid ${
                      isHovered ? COLORS.cardBorderHover : COLORS.cardBorder
                    }`,
                ...
                >
                  <div
                    ...
                    style={{
                      width: UI.iconWrapSize,
                      height: UI.iconWrapSize,
                      padding: 4,
                      flexShrink: 0,
                    }}
                  >
                    <Image
                      ...
                      style={{
                        ...
                        animation: isHovered
                          ? "octalveIconSwing 0.9s ease-in-out infinite"
                          : "none",
                        filter: isHovered
                          ? "drop-shadow(0 10px 18px rgba(0, 100, 224, 0.18))"
                          : "none",
                  ...
                  <h3
                    className="mt-4 text-[18px] font-semibold leading-tight tracking-[-0.02em] sm:text-[19px]"
                    style={{
                      color: isHovered ? COLORS.titleHover : COLORS.title,
                  ...
                  <p
                    className="mx-auto mt-5 max-w-[240px] text-[13.5px] leading-7 sm:max-w-[250px] sm:text-[14px]"
                    style={{
                      color: isHovered ? COLORS.summaryHover : COLORS.summary,
                      transition: "color 220ms ease",
                    }}
                  >
                    {item.summary}
      ...
      <style jsx global>{`
        @keyframes octalveIconSwing {
          0% {
            transform: translate3d(0, 0, 0) rotate(0deg) scale(1);
          }
          20% {
            transform: translate3d(2px, -2px, 0) rotate(7deg) scale(1.04);
          }
          40% {
            transform: translate3d(-2px, 1px, 0) rotate(-6deg) scale(1.02);
          }
          60% {
            transform: translate3d(2px, -1px, 0) rotate(5deg) scale(1.05);
          }
          80% {
            transform: translate3d(-1px, 1px, 0) rotate(-3deg) scale(1.02);
          }
          100% {
            transform: translate3d(0, 0, 0) rotate(0deg) scale(1);
          }
