...
const PACKAGES: LeapPackage[] = [
  {
    ...
    icon: FileText,
    summary:
      "A simple entry package to get your business properly registered and tax-identity ready.",
    benefit:
      "Helps early founders secure their essential CAC documents and retrieve their official NRS Corporate Tax ID, giving the business a legitimate foundation for operations.",
    bestFor:
      "Small starters, side hustles, solo founders, and first-time entrepreneurs",
    highlights: [
      "CAC Certificate",
      "Status Report",
      "NRS Corporate Tax ID",
      "Soft Copies Only",
    ],
    details: [
      "CAC Certificate",
      "Status Report",
      "NRS Corporate Tax ID Retrieval & Validation Support",
      "Soft Copies Only",
    ],
  },
  {
    ...
    icon: BadgeCheck,
    summary:
      "A stronger business starter package with tax onboarding, identity, and operational support.",
    benefit:
      "Moves the founder beyond registration by adding Rev360 taxpayer onboarding and presentation materials that improve credibility with clients, partners, and financial institutions.",
    bestFor:
      "Business owners who want a more presentable, tax-profiled, and business-ready setup",
    highlights: [
      "CAC Certificate + Tax ID",
      "Rev360 Taxpayer Onboarding",
      "Letterhead + ID Card",
      "Employer–Employee Documents",
    ],
    details: [
      ...
      "Status Report",
      "NRS Corporate Tax ID Retrieval & Validation Support",
      "Rev360 Taxpayer Profiling & Onboarding Support",
      "Letterhead",
      "ID Card",
      "CAC Frame",
      "Employer–Employee Documents",
  ...
  },
  {
    ...
    featured: true,
    summary:
      "A practical launch package for founders who want to register, organise, market, and sell properly.",
    benefit:
      "Moves the business beyond registration and tax onboarding into early market readiness with branding, sales-recording, and operational tools.",
    bestFor:
      "Startups preparing to launch, test offers, build visibility, and begin customer acquisition",
    highlights: [
      "CAC + Tax ID + Rev360",
      "Letterhead + ID Card",
      "Business Cards",
  ...
  {
    name: "Rev360 Compliance Package",
    category: "Tax Compliance Support",
    price: "₦55,000",
    icon: ShieldCheck,
    summary:
      "A structured post-onboarding package for businesses that need better visibility and organisation across their Rev360 tax profile.",
    benefit:
      "Helps registered businesses understand their tax position, organise compliance records, identify outstanding requirements, and prepare for filings, payments, and Tax Clearance Certificate applications.",
    bestFor:
      "Businesses with an active Rev360 profile that need organised tax-compliance support",
    highlights: [
      "Rev360 Profile Audit",
      "Compliance Calendar",
      "Filing-Status Review",
      "TCC Application Support",
    ],
    details: [
      "Rev360 Taxpayer Profile Audit",
      "Tax-Obligation Identification",
      "Compliance-Calendar Preparation",
      "Filing-Status Review",
      "Tax Document Organisation",
      "Assessment, Payment, and Receipt Tracking",
      "Outstanding Compliance Requirements Report",
      "Tax Clearance Certificate Application Support",
      "Liaison with a Qualified Accountant or Tax Practitioner",
      "Rev360 Account Handover and Usage Guidance",
    ],
  },
  {
    name: "Account Opening Package",
    ...
    icon: Landmark,
    summary:
      "Built for registered companies that need organised corporate, tax, and bank-account opening documentation.",
    benefit:
      "Helps formal companies establish their NRS tax identity, complete Rev360 onboarding, and approach banks with a more complete and structured account-opening file.",
    bestFor:
      "Registered companies preparing for structured business-bank account opening",
    highlights: [
      "CAC Certificate + MEMART",
      "Tax ID + Rev360 Onboarding",
      "Company Seal",
  ...
  },
  {
    ...
    icon: Building2,
    summary:
      "A more complete company package combining registration, tax onboarding, banking, personnel, and presentation tools.",
    benefit:
      "Includes the full account-opening documentation structure and adds practical materials for sales recording, personnel administration, identity, and corporate presentation.",
    bestFor:
      "Growing companies that want to appear properly structured from the beginning",
    highlights: [
      "Everything in Account Opening",
      "Sales Record Book",
      "ID Card + CAC Frame",
      "Employer–Employee Documents",
    ],
  ...
  },
  {
    ...
    badge: "Complete coverage",
    summary:
      "A comprehensive company setup package covering registration, tax readiness, banking, trademark, branding, and operational support.",
    benefit:
      "Designed for ambitious founders who want broader legal, tax, banking, operational, and brand readiness in one coordinated package.",
    bestFor:
      "Founders building a visible, compliant, and scalable company structure",
    highlights: [
      "Everything in Premium",
      "Trademark Support",
      "Rev360 Compliance Review",
      "Logo + Business Cards",
    ],
    details: [
      "CAC Certificate",
      ...
      "Tax-Obligation Identification",
      "Compliance-Calendar Preparation",
      "VAT Obligation Profiling and Registration Support, Where Applicable",
      "Electronic VAT Registration Evidence, Where Generated",
      "Trademark Acknowledgement",
      "Trademark Acceptance",
      "Letterhead",
      "ID Card",
