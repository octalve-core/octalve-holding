...
export default function LabHero() {
  ...
  const rotatingItems = [
    { label: "Logo", color: brand.red, motion: "word-rise" },
    { label: "Brand Design", color: brand.blue, motion: "word-zoom" },
    { label: "Brand Profile", color: brand.green, motion: "word-swing" },
    { label: "Website", color: brand.orange, motion: "word-slide" },
    { label: "Mobile App", color: brand.red, motion: "word-flip" },
    { label: "Software", color: brand.blue, motion: "word-blur" },
  ];
  ...
  return (
    ...
    `,
        ...
        <div className="absolute left-1/2 top-0 h-[240px] w-[72%] -translate-x-1/2 rounded-full bg-[#0064E0]/[0.12] blur-3xl sm:h-[300px] md:h-[360px]" />
        ...
        <div className="mx-auto flex min-h-[620px] max-w-[1080px] flex-col items-center justify-center text-center sm:min-h-[680px] md:min-h-[760px]">
          ...
          >
            <span className="text-[11px] font-medium tracking-[-0.02em] text-white/84 sm:text-sm">
              We design tech solutions users love, investors can&apos;t resist.
            </span>
          ...
          <p className="mt-6 max-w-[330px] text-sm leading-7 text-white/68 sm:max-w-[660px] sm:text-base sm:leading-8 md:max-w-[780px] md:text-[1.03rem]">
            We build sharp digital identities and product experiences that help
            ambitious brands look credible, communicate clearly, and grow with
            confidence.
          </p>
          ...
          <div className="mt-6 inline-flex items-center gap-2 text-center text-sm text-white/70">
            ...
            />
            Strategy-led branding and digital product execution
          </div>
        </div>
      </div>
