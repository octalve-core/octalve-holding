        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-base leading-8 text-slate-700 sm:text-lg">
              Your mission deserves a credible and donation-ready digital
              foundation.
            </p>
            ...
            <div className="mt-8">
              <Link
                href="/suite/pricing"
                className="inline-flex items-center justify-center rounded-full bg-black px-7 py-4 text-sm font-medium text-white shadow-sm transition hover:bg-slate-900"
              >
                Plans & Pricing
              </Link>
            </div>
          ...
          <div className="lg:justify-self-end">
            <div className="relative w-full max-w-2xl overflow-hidden rounded-[36px] bg-white p-6 shadow-[0_30px_90px_rgba(0,0,0,0.08)] ring-1 ring-black/5 sm:p-10">
              <div className="pointer-events-none absolute -left-16 -top-20 h-52 w-52 rounded-full bg-[#29BE3E]/18 blur-3xl" />
              ...
              <div className="relative">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-3 max-w-xl text-sm leading-7 text-slate-600 sm:text-base">
                      Get your organisation a donation-friendly brand and
                      website—fast.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-10 flex flex-wrap items-end justify-between gap-6">
                  ...
                  <Link
                    href="/suite/pricing"
                    className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-slate-100 text-slate-900 transition hover:bg-slate-200"
