...
import { impactTabs } from "../impact-data";

export default function ImpactEngineTabs() {
  const [activeTab, setActiveTab] = useState<"branding" | "website" | "assets">(
    "branding",
  );

  const active = impactTabs.find((tab) => tab.id === activeTab)!;
