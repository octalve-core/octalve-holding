...
import { IMPACT_COLORS, impactSteps } from "../impact-data";
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      borderColor: isDone ? IMPACT_COLORS.primary : "#DDF3E1",
                      boxShadow: isDone
                        ? "0 0 0 6px rgba(41,190,62,0.14)"
                        : "none",
                    }}
                    aria-hidden="true"
                  >
                  ...
                  <div className="lg:pl-6">
                    <div
                      ...
                      style={{
                        backgroundColor: step.highlight ? "#F1FFF4" : "#F8FAFC",
                      }}
                    >
