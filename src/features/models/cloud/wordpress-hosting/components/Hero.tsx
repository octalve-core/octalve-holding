      ...
      <div className="mx-auto max-w-[1280px] px-5 py-20 sm:px-6 lg:px-8 lg:py-24">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-6 text-4xl font-semibold tracking-[-0.03em] text-slate-950 sm:text-5xl lg:text-6xl">
            WordPress hosting built for faster launch, easier management, and
            better growth.
          </h1>

          <p className="mt-6 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
            Launch blogs, company websites, landing pages, and content-driven
            platforms on WordPress hosting designed for simplicity, stability,
