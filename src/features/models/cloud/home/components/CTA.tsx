        ...
        <div className="rounded-[32px] bg-[#2563EB] px-6 py-12 sm:px-10 lg:px-14">
          <div className="max-w-3xl">
            <h2 className="text-3xl font-semibold tracking-[-0.02em] text-white sm:text-4xl">
              Start building your online infrastructure with confidence
            </h2>
            <p className="mt-4 text-base leading-7 text-blue-50/90">
              Create an account, search your domain, and prepare your business
              for hosting, email, security, and future scale.
            </p>

            <div className="mt-8 flex flex-wrap items-center gap-4">
              <Link
                href={cloudConsoleLinks.signUp}
                className="inline-flex rounded-full bg-white px-6 py-3 text-sm font-semibold text-[#2563EB] transition hover:bg-slate-100"
              >
                Create account
              </Link>
