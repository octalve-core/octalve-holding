const results = [
  "More flexible work access",
  "Stronger professional presence",
  "Better collaboration opportunities",
  "Easier meeting and event hosting",
  "Improved startup support environment",
  "A smarter base for modern work",
];

export default function NodeResults() {
  return (
      ...
      <div className="mx-auto max-w-[1200px] rounded-[32px] bg-slate-950 px-6 py-10 text-white sm:px-8 md:px-10">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-4 text-3xl font-medium tracking-[-0.03em] sm:text-4xl">
            Better work environments with practical business support.
          </h2>
        </div>
