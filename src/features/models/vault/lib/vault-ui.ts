export const vaultUi = {
  ...
  subtleButton:
    "inline-flex items-center justify-center rounded-full border border-slate-300 !bg-slate-100 px-5 py-3 text-sm font-semibold !text-slate-900 transition-colors duration-200 hover:!bg-slate-200 hover:!text-black",
  dangerButton:
    "inline-flex items-center justify-center rounded-full border border-rose-200 bg-rose-50 px-5 py-3 text-sm font-semibold text-rose-700 transition-colors duration-200 hover:bg-rose-100",
};
