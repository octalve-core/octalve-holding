      ...
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
        <div className="grid items-center gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:gap-8 xl:gap-10">
          <div className="max-w-2xl">
            <h1 className="text-[2.65rem] font-medium leading-[0.98] tracking-[-0.06em] text-[#0F172A] sm:text-5xl lg:text-[4.35rem]">
              <span className="text-[#0F172A]">Idea.</span>{" "}
              <span style={{ color: LAUNCH_COLORS.primary }}>Launch</span>{" "}
              <span className="text-[#0F172A]">Faster</span>
            </h1>

            <h2 className="mt-6 text-[1.3rem] font-medium leading-[1.35] text-[#334155] sm:text-[1.5rem]">
              From &ldquo;Side Project&rdquo; to &ldquo;Market Leader.&rdquo;
            </h2>
            ...
            <p className="mt-4 max-w-xl text-[1.02rem] leading-8 text-[#475569] sm:text-[1.12rem] sm:leading-9">
              ...
              We provide the complete identity, professional sale-AI driven
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
              ...
              <Link
                ...
                style={{
                  ...
                  boxShadow: "0 10px 30px rgba(230,21,37,0.16)",
                }}
              >
                Start Now
              </Link>
          ...
          <div className="w-full lg:justify-self-stretch">
            <div className="mx-auto w-full max-w-[740px] rounded-[34px] bg-[linear-gradient(135deg,#F2A48F_0%,#F3CDB8_38%,#ECE7DA_100%)] p-3.5 shadow-[0_24px_70px_rgba(15,23,42,0.08)] ring-1 ring-black/5 sm:rounded-[38px] sm:p-4 lg:ml-auto lg:max-w-[760px] lg:p-5">
