...
const CONTACT_ITEMS: ContactItem[] = [
  {
    ...
    icon: <MapPin className="h-6 w-6" strokeWidth={1.9} />,
    iconClassName: "bg-[#E61525]/10 text-[#E61525]",
    badgeClassName: "bg-[#E61525]/10 text-[#E61525]",
    external: true,
  },
  {
    id: "nigeria-phone",
    ...
    value: "+234 807 345 9090",
    description:
      "Best for calls, WhatsApp enquiries, project briefs, and local business conversations.",
    href: CONTACT_LINKS.nigeriaPhone,
    actionLabel: "Call NG",
    icon: (
      <PhoneIconWithFlag flagUrl="https://flagcdn.com/ng.svg" label="Nigeria" />
    ),
    iconClassName: "bg-[#0064E0]/10 text-[#0064E0]",
    badgeClassName: "bg-[#0064E0]/10 text-[#0064E0]",
  },
  {
    id: "uk-phone",
    title: "UK Line",
    value: "+44 7413 753552",
    description:
      "Best for UK-based clients, partners, collaborations, and international enquiries.",
  ...
  },
  {
    ...
    icon: <Mail className="h-6 w-6" strokeWidth={1.9} />,
    iconClassName: "bg-[#29BE3E]/10 text-[#159A2B]",
    badgeClassName: "bg-[#29BE3E]/10 text-[#159A2B]",
  },
];

function PhoneIconWithFlag({
  flagUrl,
  label,
}: {
  flagUrl: string;
  ...
  return (
    <div className="relative">
      <PhoneCall className="h-6 w-6" strokeWidth={1.9} />

      <img
        src={flagUrl}
        alt={`${label} flag`}
        loading="lazy"
        className="absolute -bottom-2 -right-2 h-5 w-5 rounded-full border-2 border-white object-cover shadow-sm"
      />
    </div>
  );
}
